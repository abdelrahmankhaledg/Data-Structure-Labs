...
@Test
void testGet3() {
	Study2 emptyList=new Study2();
	assertThrows(IllegalArgumentException.class,()-> emptyList.get(3));
}
...
void testSet2() {
	Study2 emptyList=new Study2();
	assertThrows(RuntimeException.class,()-> emptyList.set(10, N));
}
@Test
void testSet3() {
...
@Test 
void testRemove4() {
	List.remove(0);//We added (1,2) as the first element ,after removing it P will be the first
	assertEquals(P,List.get(0));
}
@Test
void testRemove5() {
...
@Test
void TheLastTest1() {
	ILinkedList SubList=new Study2();
	SubList=(Study2)(List.sublist(1,3));
...
void TheLastTest5() {
	ILinkedList SubList=new Study2();
	SubList=(Study2)(List.sublist(0,2));
	assertEquals(3,SubList.size());
